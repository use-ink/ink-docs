...
* To get started with development, head over to the [ink!athon repository](http://localhost:8080/getting-started/inkathon) and check its README.

## Workshop Video

Get a quickstart into the boilerplate with this talk recording by [Dennis Zoma](https://events.polkadot.network/event/sub0-europe-2023/planning/UGxhbm5pbmdfMTU2MTE1NQ==) at the sub0 Developer Conference in Lisbon 2023: [Start Building dApps on ink!](https://events.polkadot.network/event/sub0-europe-2023/planning/UGxhbm5pbmdfMTU2MTE1NQ==) (45 min, starts at 3:17:00).

[![inkathon Workshop Video Preview Image](/img/inkathon-workshop-video-preview.jpg)](https://TODO)
