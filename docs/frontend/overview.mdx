...
<div className="max-w-2xl mx-auto text-center mb-12">
  <p>
    ...
    wallet connections, encoding and decoding contract calls and transactions, and accessing chain information. <a href="https://scio.xyz" target="_blank">
      Get started.
    </a>
  </p>
</div>
...
<div className="max-w-2xl mx-auto text-center mb-12">
  <p>
    ...
    you scaffold any dApp quickly. It's developed by the same team that is behind <a href="https://azero.id" target="_blank">
      AZERO.ID
    </a>, where this boilerplate is used in production. <a href="https://scio.xyz" target="_blank">
      Get started.
    </a>
  </p>
</div>
