...
by [useCall](/frontend/react/hooks/contracts/use-call), and similar hooks.
...
[useCall](/frontend/react/hooks/contracts/use-call), and similar hooks.
...
E>`. Can be used with [useCall](/frontend/react/hooks/contracts/use-call) and similar
hooks.
...
[useTx](/frontend/react/hooks/contracts/use-tx),
[useDryRun](/frontend/react/hooks/contracts/use-dry-run), and similar hooks.
