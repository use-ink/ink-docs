...
ink! also provides a `Mapping` storage type. You can read more about it [here](docs/datastructureses/mapping.md).
...
[`Mapping` documentation](docs/datastructureses/mapping.md) for more details.
