...
See the [`examples/erc20`](https://github.com/paritytech/ink-examples/blob/master/erc20/lib.rs) contract on how to utilize those or [the documentation](https://docs.rs/ink/4.0.0/ink/attr.test.html) for details.
...
[flipper example](https://github.com/paritytech/ink-examples/blob/master/flipper/lib.rs).
