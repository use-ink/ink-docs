...
[contract metadata](docs/basics/metadata.md) by looking for the `selector` field of the dispatchable
...
[macro](docs/basics/trait-definitions.md). For our first step, instead of taking _just_ the
