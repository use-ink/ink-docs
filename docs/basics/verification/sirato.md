...
[compile your contract](docs/getting-startedcompiling.md).
...
[flipper example](docs/getting-startedcreating.md) you would see 
...
[deploy your contract](docs/getting-starteddeploying.md).
