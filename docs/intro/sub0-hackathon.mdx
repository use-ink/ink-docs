...
We also have some xcm examples available [here](https://github.com/r0gue-io/symbiosis-contract-examples), and a contract using the assets precompile with full end to end tests [here](TODO): 
