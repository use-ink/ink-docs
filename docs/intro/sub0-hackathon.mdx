...
hide_title: true
slug: /hackathon-fast-track
---

<head>
    <meta name="description" content="Quickstart page to use ink! in a hackathon." />
    <meta name="keywords" content="sub0 hackathon, Polkadot SDK, ink!, pallet-revive, Smart Contracts" />
    <meta property="og:title" content="Quickstart: ink! for hackathons" />
    <meta property="og:description" content="Fast track for using ink! at hackathons" />
    <meta property="og:image" content="https://use.ink/img/opengraph/riscv-polkavm.png" />
</head>
...
<img src={useBaseUrl('/img/title/frontend.svg')} title="The ink! 6.0 smart contracts toolkit release" width="800" style={{ marginBottom: 10 }} />

# Hackathon Fast Track

This page contains all necessary info to participate in the hackathons using ink! v6.
