...
There are other ink! macros, for which details can be found at [Macros & Attributes](docs/macros-attributeses/overview.md).
...
For ink! you can also find [a setup guide](docs/getting-starteded/setup.md) which will help you
...
- [Instructions for `contracts-ui`](docs/getting-starteded/deploying.md)
