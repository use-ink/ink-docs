...
[`Storable`](https://docs.rs/ink_storage_traits/6.0.0-alpha/ink_storage_traits/trait.Storable.html)
...
[`StorageLayout`](https://docs.rs/ink_storage_traits/6.0.0-alpha/ink_storage_traits/trait.StorageLayout.html)
...
[`#[ink::storage_item]`](https://docs.rs/ink_macro/6.0.0-alpha/ink_macro/attr.storage_item.html),
...
non-[`Packed`](https://docs.rs/ink_storage_traits/6.0.0-alpha/ink_storage_traits/trait.Packed.html) 
types. Without it, the key for non-`Packed` fields will be zero. Using this macro is 
necessary if you don't plan to use a
[`ManualKey`](https://docs.rs/ink_storage_traits/6.0.0-alpha/ink_storage_traits/struct.ManualKey.html) 
...
[`Mapping`](https://docs.rs/ink_storage/6.0.0-alpha/ink_storage/struct.Mapping.html).
