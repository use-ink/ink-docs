...
function from it can now be found [in the `ink_env` crate](https://docs.rs/ink_env/5.0.0/ink_env/fn.ecdsa_to_eth_address.html).
...
- [`Mapping::contains(key)`](https://docs.rs/ink_storage/5.0.0/ink_storage/struct.Mapping.html#method.contains)
  in [#1224](https://github.com/paritytech/ink/pull/1224).
- [`Mapping::take()`](https://docs.rs/ink_storage/5.0.0/ink_storage/struct.Mapping.html#method.take)
...
of [`ink_env::set_contract_storage()`](https://docs.rs/ink_env/5.0.0/ink_env/fn.set_contract_storage.html)
was changed to return an `Option<u32>` instead of `()`.

A new function [`ink_env::take_contract_storage`](https://docs.rs/ink_env/5.0.0/ink_env/fn.take_contract_storage.html)
was introduced.
...
A [`LangError`](https://docs.rs/ink/5.0.0/ink/enum.LangError.html)
...
[`CallBuilder::invoke()`](https://docs.rs/ink_env/5.0.0/ink_env/call/struct.CallBuilder.html#method.invoke-2).
...
[`CreateBuilder::try_instantiate()`](https://docs.rs/ink_env/5.0.0/ink_env/call/struct.CreateBuilder.html#method.try_instantiate)
or
[`CallBuilder::try_invoke()`](https://docs.rs/ink_env/5.0.0/ink_env/call/struct.CallBuilder.html#method.try_invoke-1)
methods.
...
[`Call`](https://docs.rs/ink_env/5.0.0/ink_env/call/struct.Call.html)
and
[`DelegateCall`](https://docs.rs/ink_env/5.0.0/ink_env/call/struct.DelegateCall.html)
workflows:
- For `Call` you can use
  [`CallBuilder::call()`](https://docs.rs/ink_env/5.0.0/ink_env/call/struct.CallBuilder.html#method.call) (this replaces `CallBuilder::callee()`)
- For `DelegateCall` you can use [`CallBuilder::delegate()`](https://docs.rs/ink_env/5.0.0/ink_env/call/struct.CallBuilder.html#method.delegate)
