...
tener una estructura especializada y que la principial macro [`#[ink::contract]`](https://docs.rs/ink_lang/4.0.0-rc/ink_lang/attr.contract.html) pueda generar correctamente código para su implementación.
