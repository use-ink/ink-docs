...
### En Testnet con Mainnet a seguir
...
<div className="row">
    <div className="col text--center">
        <a href="https://t3rn.io">
            <img src= "/img/chains/t3rn.png" className="chain" />
        </a>
    </div>
    <div className="col text--center">
        <a href="http://alephzero.org">
            <img src= "/img/chains/aleph-zero.svg" className="chain" />
        </a>
    </div>
    <div className="col text--center">
        <a href="https://www.phala.network">
...
<div className="row">
    ...
    <div className="col text--center">
        <a href="https://bit.country">
            <img src= "/img/chains/bitcountry.png" className="chain" />
        </a>
    </div>
    <div className="col text--center">
