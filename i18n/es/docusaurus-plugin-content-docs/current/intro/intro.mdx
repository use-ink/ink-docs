...
<center>
    <em>ink! es un lenguaje de programación para smart contracts.<br/>Puedes utilizarlo en Blockchains desarrollados con el framework de <a href="https://github.com/paritytech/substrate">Substrate</a>.</em>
</center>
</h3>
...
<div className="row">
    <div className="col text--center">
        ...
        <p>
            ...
            <a href="https://www.parity.io/blog/what-is-paritys-ink">» Ver página</a>
        </p>
    </div>
    <div className="col text--center">
        ...
        <p>
            ...
            <a href="https://docs.substrate.io/tutorials/smart-contracts/">» ver tutorial</a>
        </p>
    </div>
</div>
