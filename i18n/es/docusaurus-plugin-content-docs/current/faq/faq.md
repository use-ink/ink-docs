...
Pr favor mira [el argumento `env_types`](https://docs.rs/ink_macro/4.0.0/ink_macro/attr.contract.html#header-arguments)
...
ver la lista completa [aquí](https://docs.rs/ink_env/4.0.0/ink_env/hash/trait.CryptoHash.html).
