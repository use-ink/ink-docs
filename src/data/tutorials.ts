export const tutorials = [
  {
    ...
    description: 'Build your very first smart contract with ink!',
    link: 'tutorials/beginner/first-contract',
  },
  {
    image: '/img/title/heart.svg',
    title: 'Creating an ink! Project',
    description: 'Learn how to get started with ink! and build your first contract',
    link: 'tutorials/getting-started/creating-an-ink-project',
  },
  {
