  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen dark:bg-gradient-to-b dark:from-purple-900 dark:via-black dark:to-purple-400">
      ...
      <div className="flex flex-row gap-4">
        <a href={`${baseUrl}/docs`} className="text-purple-300 underline hover:text-purple-400">
          docs →
        </a>
        <a href={`${baseUrl}/ubator`} className="text-purple-300 underline hover:text-purple-400">
          ink!ubator →
        </a>
      </div>
    </div>
