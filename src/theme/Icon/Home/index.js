    ...
    if (isDarkTheme) {
        return (
            ...
            >
                <style>
                    {
                        ".prefix__st0{opacity:.75}.prefix__st1{fill-rule:evenodd;clip-rule:evenodd;fill:#e3e3e3}.prefix__st2{fill:#fff}"
                    }
                </style>
                <g className="prefix__st0">
                    <path
                        className="prefix__st1"
                        d="M6.9 47.1h2.4c8.8-26.7-22.6-20.4-2.4 0z"
                    />
                </g>
                <g className="prefix__st0">
                    <path
                        className="prefix__st1"
                        d="M6.9 49.1h2.4c8.8 26.7-22.6 20.4-2.4 0z"
                    />
                </g>
                <g className="prefix__st0">
                    <path
