...
There are other ink! macros, for which details can be found at [Macros & Attributes](versioned_docs/version-4.x/macros-attributeson-4.x/macros-attributes/overview.md).
...
For ink! you can also find [a setup guide](versioned_docs/version-4.x/getting-startedsion-4.x/getting-started/setup.md) which will help you
...
- [Instructions for `contracts-ui`](versioned_docs/version-4.x/getting-startedsion-4.x/getting-started/deploying.md)
