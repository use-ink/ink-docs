...
* You can write tests using one of the mechanisms described on the
  [Contract Testing](versioned_docs/version-4.x/basics/testing.md) page.
* You can interact with your contract via a UI or command-line. This is
  described on the [Call Your Contract](versioned_docs/version-4.x/getting-startedsion-4.x/getting-started/calling.md) page.
