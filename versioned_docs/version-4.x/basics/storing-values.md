...
ink! also provides a `Mapping` storage type. You can read more about it [here](versioned_docs/version-4.x/datastructuresrsion-4.x/datastructures/mapping.md).
...
[`Mapping` documentation](versioned_docs/version-4.x/datastructuresrsion-4.x/datastructures/mapping.md) for more details.
