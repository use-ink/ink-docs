...
- [General storage documentation](versioned_docs/version-4.x/datastructuresrsion-4.x/datastructures/overview.md)
- [Storage metadata format](versioned_docs/version-4.x/datastructuresrsion-4.x/datastructures/storage-in-metadata.md)
