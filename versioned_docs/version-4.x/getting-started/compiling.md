...
to the node's console if debugging was enabled on the node ([instructions here](versioned_docs/version-4.x/faqned_docs/version-4.x/faq/faq.md#how-do-i-print-something-to-the-console-from-the-runtime)).
