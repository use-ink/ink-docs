...
<center>
    <img src="/img/title/ink!-5.0.svg" title="The ink! 5.0 smart contracts toolkit release" width="800" style={{ marginBottom: 10 }} />
</center>
...
You can read more on standards [here](/5.x/standards/overview).
