...
The chapter [Technical Background](../background/polkadot) of this documentation describes
...
If you already have an ink! v5 contract: there is a migration guide available [here](../faq/migration-from-ink-5-to-6.md).
